...
|---|---|---|
| `Stable` | Intended for long-lived integrations. | No intentional breaking changes in patch releases (`0.2.z`). Breaking changes in a new minor (`0.3`) require migration notes. |
